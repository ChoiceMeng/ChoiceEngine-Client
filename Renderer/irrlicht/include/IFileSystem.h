...
public:
	...
	See IReferenceCounted::drop() for more information.
	*/
	virtual IReadFile* createMemoryReadFile(const void* memory, s32 len, const path& fileName, bool deleteMemoryWhenDropped=false, bool makeLocalCopy=false) =0;
	...
	*/
	...
	See IReferenceCounted::drop() for more information.
	*/
	virtual IWriteFile* createMemoryWriteFile(void* memory, s32 len, const path& fileName, bool deleteMemoryWhenDropped=false, bool makeLocalCopy=false) =0;
